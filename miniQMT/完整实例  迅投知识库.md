---
title: "完整实例 | 迅投知识库"
source: "https://dict.thinktrader.net/nativeApi/code_examples.html?id=H18Urc"
author:
published:
created: 2025-08-18
...
published_time:
tags:
  - "#QMT #PythonAPI #迅投知识库 #交易示例 #行情示例"
summary: "这篇文章介绍了迅投知识库中关于QMT-Python-API的使用说明和示例代码。"
---
# 文章总结
这篇文章介绍了迅投知识库中关于QMT-Python-API的使用说明和示例代码。
# 标签
#QMT #PythonAPI #迅投知识库 #交易示例 #行情示例
# 正文内容
## 行情示例
